 ...
 * @param {string} [optScriptId] The script ID of your script, which can be found
 *     in the Script Editor UI under "File > Project properties". Defaults to
 *     the script ID of the script being executed.
